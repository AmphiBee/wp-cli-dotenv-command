...
class SaltsCommand extends Command
{
     ...
     * @param $assoc_args
     */
    public function generate($_, $assoc_args): void
    {
     ...
     * @param $assoc_args
     */
    public function regenerate($_, $assoc_args): void
    {
        $this->init_args(func_get_args());
     ...
     * @return bool
     */
    protected function salts_are_placeholders(): bool
    {
     ...
     *
     * @param bool $force Whether to force update any existing values
     *
     * @return Collection
     */
    protected function update_salts(bool $force = false): Collection
    {
