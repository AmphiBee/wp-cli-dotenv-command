...
class FileLines extends Collection
{
     ...
     * @return static
     */
    public static function load($filePath): static
    {
     ...
     * @return mixed
     */
    public static function fromArray(array $lines): mixed
    {
     ...
     * @return $this
     */
    public function add(LineInterface $line): static
    {
     ...
     * @return mixed
     */
    public function getDefinition($key, $default = null): mixed
    {
     ...
     * @param LineInterface $line
     */
    public function updateOrAdd(LineInterface $line): void
    {
        $key = $line->key();
     ...
     * @return bool
     */
    public function hasDefinition($varName): bool
    {
     ...
     * @return $this
     */
    public function removeDefinition(string $varName): static
    {
     ...
     * @return Collection
     */
    public function toDictionary(): Collection
    {
     ...
     *
     * @param array|string|Collection $patterns
     *
     * @return static
     */
    public function whereKeysLike(Collection|array|string $patterns): static
    {
